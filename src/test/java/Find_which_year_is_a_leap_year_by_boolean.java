...
public class Find_which_year_is_a_leap_year_by_boolean {
    ...
    public void check_leapyears_if_years_is_dividable_with_4_but_not_100_and_dividable_with_400(int years){
    ...
    public void check_not_leapyears_if_years_is_not_dividable_with_4_but_dividable_with_100_and_not_400(int years){
        LeapYear Test = new LeapYear();
